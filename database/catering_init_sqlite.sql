...
-- =====================================================
-- TABELLE PER IL MODULO STAFF MANAGEMENT
-- =====================================================
...
CREATE TABLE Lavoratori (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    nome TEXT NOT NULL,
    ferie_richieste BOOLEAN DEFAULT 0,
    ferie_approvate BOOLEAN DEFAULT 0,
    motivo_ferie TEXT
);
...
-- VALUTAZIONI_LAVORATORE
CREATE TABLE ValutazioniLavoratore (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    lavoratore_id INTEGER NOT NULL,
    nome_evento TEXT NOT NULL,
...
-- VALUTAZIONI_EVENTO
CREATE TABLE ValutazioniEvento (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    nome_evento TEXT NOT NULL,
    punteggio INTEGER NOT NULL CHECK (punteggio BETWEEN 1 AND 5),
    commento TEXT
